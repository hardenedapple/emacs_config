...
* Things to Do
Make single function to restart ipython interpreter in inferior python mode
    Currently I send "quit" to the kernel, move into a python buffer, then run
    `python-shell-switch-to-shell' again, this should be easy to automate.

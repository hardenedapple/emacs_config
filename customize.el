(custom-set-variables
 ...
 '(package-selected-packages
   '(vsh slime register-list magit buffer-move window-number smex multiple-cursors markdown-mode jump-char paredit keyswap ido-completing-read+ avy goto-chg feature-mode c-eldoc wrap-region xcscope expand-region rust-mode ido-at-point transpose-mark monokai-theme smart-tab monky dot-mode elisp-slime-nav ido-vertical-mode undo-tree move-text projectile smart-window vimrc-mode))
